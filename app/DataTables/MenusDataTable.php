...
class MenusDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addIndexColumn()
            ->addColumn('action', function(MenusModel $val){
                return Livewire::mount('pages.admin.menus.menus-table-action', ['menus' => $val]);
            })
            ->editColumn('is_active', function(MenusModel $val){
     ...
     */
    public function query(MenusModel $model): QueryBuilder
    {
